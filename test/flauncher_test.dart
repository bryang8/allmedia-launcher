...
void main() {
  ...
  testWidgets("Home page shows categories with apps", (tester) async {
    ...
    when(appsService.categoriesWithApps).thenReturn([
      CategoryWithApps(favoritesCategory, [
        fakeApp(
          packageName: "com.allmedia.launcher.1",
          name: "FLauncher 1",
          version: "1.0.0",
    ...
    expect(find.byKey(Key("${applicationsCategory.id}-com.allmedia.launcher.2")), findsOneWidget);
    expect(find.byType(CategoryRow), findsOneWidget);
    expect(find.byKey(Key("${favoritesCategory.id}-com.allmedia.launcher.1")), findsOneWidget);
  ...
  testWidgets("Long pressing on app opens ApplicationInfoPanel", (tester) async {
    ...
    await tester.longPress(find.byKey(Key("${applicationsCategory.id}-com.allmedia.launcher")));
    await tester.pump();
